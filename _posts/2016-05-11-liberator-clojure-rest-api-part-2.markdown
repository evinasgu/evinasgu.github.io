...
In [the first part](http://localhost:4000/liberator-clojure-rest-api-part-1/) of this approach, we started a clojure project with *lein compojure* template and we
